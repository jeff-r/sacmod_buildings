...
class ArchitectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create architect" do
    assert_difference('Architect.count') do
      post architects_url, params: { architect: { description: @architect.description, name: @architect.name } }
    end
  ...
  test "should update architect" do
    patch architect_url(@architect), params: { architect: { description: @architect.description, name: @architect.name } }
